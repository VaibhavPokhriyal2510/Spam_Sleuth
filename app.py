...
if selected == "Home":
    ...
    st.markdown(
        ...
        """, unsafe_allow_html=True)
    st.markdown('<p class="spam-headers">It is recommended to use light theme for better visuals.<br><br>1.Go to settings.<br>2.Go to preferences and select colors.<br>3.Then select light.',unsafe_allow_html=True)
